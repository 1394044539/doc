...
CREATE TABLE `sys_notice`  (
  ...
  `is_open` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否首页打开(0:否,1:是)',
...
CREATE TABLE `user_collection`  (
  ...
  `collection_type` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '收藏类型(0:分卷,1:小说,2:文件夹)',
